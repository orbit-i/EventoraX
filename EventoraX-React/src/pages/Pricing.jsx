...
const trustItems = [
  ...
  {
    path: "M434.8 54.1C446.7 62.7 451.1 78.3 445.7 91.9L367.3 288L512 288C525.5 288 537.5 296.4 542.1 309.1C546.7 321.8 542.8 336 532.5 344.6L244.5 584.6C233.2 594 217.1 594.5 205.2 585.9C193.3 577.3 188.9 561.7 194.3 548.1L272.7 352L128 352C114.5 352 102.5 343.6 97.9 330.9C93.3 318.2 97.2 304 107.5 295.4L395.5 55.4C406.8 46 422.9 45.5 434.8 54.1z",
    bold: "Instant",
    text: "Account Setup",
  },
  {
    path: "M320 128C241 128 175.3 185.3 162.3 260.7C171.6 257.7 181.6 256 192 256L208 256C234.5 256 256 277.5 256 304L256 400C256 426.5 234.5 448 208 448L192 448C139 448 96 405 96 352L96 288C96 164.3 196.3 64 320 64C443.7 64 544 164.3 544 288L544 456.1C544 522.4 490.2 576.1 423.9 576.1L336 576L304 576C277.5 576 256 554.5 256 528C256 501.5 277.5 480 304 480L336 480C362.5 480 384 501.5 384 528L384 528L424 528C463.8 528 496 495.8 496 456L496 435.1C481.9 443.3 465.5 447.9 448 447.9L432 447.9C405.5 447.9 384 426.4 384 399.9L384 303.9C384 277.4 405.5 255.9 432 255.9L448 255.9C458.4 255.9 468.3 257.5 477.7 260.6C464.7 185.3 399.1 127.9 320 127.9z",
    bold: "24/7",
...
const comparisonRows = [
  { feature: "Unlimited Events", pro: true, enterprise: true },
  { feature: "QR Tickets & Check-in", pro: true, enterprise: true },
  { feature: "Analytics & Reports", pro: true, enterprise: true },
  { feature: "Volunteer Management", pro: true, enterprise: true },
  { feature: "Sponsors Management", pro: true, enterprise: true },
  { feature: "Custom Registration Forms", pro: true, enterprise: true },
  { feature: "Email & SMS Notifications", pro: true, enterprise: true },
  { feature: "API Access", pro: false, enterprise: true },
  { feature: "White Label (Your Branding)", pro: false, enterprise: true },
  { feature: "Priority Support", pro: false, enterprise: true },
  { feature: "Dedicated Account Manager", pro: false, enterprise: true },
  { feature: "Multiple Organizations", pro: false, enterprise: true },
  { feature: "SLA & Uptime Guarantee", pro: false, enterprise: true },
];

const pricingFaqColumns = [
  [
    {
      q: "How does billing work?",
      a: "You are billed annually. Your subscription renews automatically unless cancelled.",
    },
    {
      q: "Can I cancel my subscription anytime?",
      a: "Yes. You may cancel anytime from your dashboard.",
    },
    {
      q: "Can I upgrade later?",
      a: "Absolutely. Upgrade whenever you need more features.",
    },
  ],
  [
    {
      q: "Which payment methods are accepted?",
      a: "JazzCash, Easypaisa and Bank Transfer.",
    },
    {
      q: "Do I lose my data if I cancel?",
      a: "No. Your data remains available during the retention period.",
    },
    {
...
function Pricing() {
  useEffect(() => {
    ...
    return () => document.body.classList.remove("page-pricing");
  }, []);

  const [openFaq, setOpenFaq] = useState(null); // "colIndex-itemIndex"
    ...
    <div className="page-pricing">
      ...
      <section className="pricing-hero">
        ...
        <div className="hero-content">
          <div className="hero-left">
            ...
            <p>
              Everything you need to plan, manage and run events successfully
              – at a price that grows with you.
            </p>
        ...
        <div className="trust-box">
          {trustItems.map((item) => (
            <div key={item.bold}>
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                  <path fill="rgb(53, 37, 205)" d={item.path} />
                </svg>
              </span>
              <b>{item.bold}</b>
              <br />
      ...
      <section className="feature-comparison">
        <div className="comparison-heading">
          ...
          <h2>
            Compare <span>EventoriaX</span> Plans
          </h2>
        ...
        <div className="container">
          ...
          <div className="payment-grid">
            <div className="payment-card">
              <img src="/jazzcash.png" alt="JazzCash" className="jazzcash" />
              <h4>JazzCash</h4>
              <p>Pay instantly using your JazzCash wallet.</p>
            </div>

            <div className="payment-card">
              <img src="/easypiasa.png" alt="EasyPaisa" />
              <h4>EasyPaisa</h4>
          ...
          <div className="trial-box">
            <div className="trial-left">
              ...
              <div className="trial-text">
                <h2>
                  Try <span>EventoriaX</span> Free for 1 Day
                </h2>
                <p>Experience every premium feature with zero risk.</p>

                <ul>
                  <li>
                    <i className="fa-solid fa-circle-check"></i> No Credit
                    Card Required
                  </li>
                  <li>
                    <i className="fa-solid fa-circle-check"></i> Cancel
                    Anytime
                  </li>
                  <li>
                    <i className="fa-solid fa-circle-check"></i> Full Premium
                    Access
                  </li>
                </ul>
              </div>
      ...
      <section className="faq-section">
        <div className="container">
          ...
          <div className="faq-grid">
            {pricingFaqColumns.map((column, colIndex) => (
              <div className="faq-column" key={colIndex}>
                {column.map((item, itemIndex) => {
                  const key = `${colIndex}-${itemIndex}`;
                  const isOpen = openFaq === key;
                  return (
                    <div className={`faq ${isOpen ? "active" : ""}`} key={key}>
                      <button className="faq-btn" onClick={() => toggleFaq(key)}>
                        <span>{item.q}</span>
